                       ...
                       by_modules = FALSE, df0 = NULL, digits = 4L)
{
  ...
  parallel::clusterExport(
    ...
    c("ms2match_all", "gen_ms2ions_base", 
      ...
      "calc_rev_ms2", "match_mvmods", "expand_grid_rows", 
      "find_vmodscombi", "combi_namesiteU", "find_vmodposU", 
      "vec_to_list", "sim_combn", "combi_namesiteM", "find_vmodposM", 
      "match_aas_indexes", "check_ms1_mass_vmods2", 
      ...
      "add_hexcodes_vnl2", "add_hexcodes_fnl2", "add_hexcodes", 
...
ms2match_one <- function (pep_mod_group, aa_masses, FUN, 
                          ...
                          maxn_fnl_per_seq = 8L, maxn_vnl_per_seq = 8L, 
                          maxn_vmods_sitescombi_per_pep = 64L, 
                          minn_ms2 = 6L, ppm_ms1 = 10L, ppm_ms2 = 10L, 
                          min_ms2mass = 115L, index_mgf_ms2 = FALSE, 
                          df0 = NULL, digits = 4L) 
