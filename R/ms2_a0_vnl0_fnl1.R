...
ms2match_a0_vnl0_fnl1 <- function (i, aa_masses, ntmass, ctmass, fmods_nl, 
  ...
  parallel::clusterExport(cl, list("frames_adv_a0_vnl0_fnl1"), 
                          envir = environment(proteoQ:::frames_adv_a0_vnl0_fnl1))
  parallel::clusterExport(cl, list("gen_ms2ions_a0_vnl0_fnl1"), 
                          envir = environment(proteoQ:::gen_ms2ions_a0_vnl0_fnl1))
