...
# 
# $ms2frames.R
#  [1] "pair_mgftheos"   "hpair_mgths"     "make_dia_mgfs"   "clean_flat_mgfs" "hms2match"       "find_ms2_bypep" 
#  [7] "search_mgf"      "hms2match_one"   "ms2match_one"    "frames_adv"     
# 
# $msfilereader.R
...
#  [7] "predeisoDDA"       "deisoDDAMS2"       "pasefMS1xyz"       "getMSrowIndexes"   "find_ms2ends"      "getMS1xyz"        
# [13] "getMS2xyz"         "extrDIA"           "hdeisoDIA"         "deisoDIA"          "hsubDIAMS1"        "subDIAMS1"        
# [19] "htraceDIA"         "traceDIA"          "flattenMSxyz"      "spreadMSohw"       "spreadMS_v1"       "comb_mstraces"    
# [25] "find_gates"        "find_gate_edges"   "traceLCMS"         "collapse_xyz"      "mapcoll_xyz"       "find_lc_gates"    
# [31] "fill_lc_gaps"      "collapse_mms1ints" "calc_ms1xys"       "find_mdda_mms1s"   "find_ms1byms2"    
# 
# $mztab.R
# [1] "make_mztab"
# 
...
#  [9] "sum_pasef_ms1"          "collapse_rawtims_xys"   "group_pasef_precursors" "add_pasef_ms2iso"      
