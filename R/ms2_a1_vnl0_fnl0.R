...
ms2match_a1_vnl0_fnl0 <- function (i, aa_masses, ntmod = NULL, ctmod = NULL, 
  ...
  parallel::clusterExport(cl, list("frames_adv_a1_vnl0_fnl0"), 
                          envir = environment(proteoQ:::frames_adv_a1_vnl0_fnl0))
  parallel::clusterExport(cl, list("gen_ms2ions_a1_vnl0_fnl0"), 
                          envir = environment(proteoQ:::gen_ms2ions_a1_vnl0_fnl0))
  ...
  parallel::clusterExport(cl, list("calc_ms2ions_a1_vnl0_fnl0"), 
                          envir = environment(proteoQ:::calc_ms2ions_a1_vnl0_fnl0))
  ...
  parallel::clusterExport(cl, list("add_hexcodes"), 
                          envir = environment(proteoQ:::add_hexcodes))
